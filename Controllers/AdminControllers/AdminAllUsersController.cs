...
namespace RecipeProject.Controllers.AdminControllers
{
    public class AdminAllUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Firstname,Lastname,Username,Password,Gender,Email,Phone,RoleId,CreatedDate,ModifiedDate,CreatedBy,ModifiedBy,IsDeleted,id")] Person person)
        {
