...
{
    public class AdminAllChefsController : Controller
    {
        ...
        // POST: AdminAllChefs/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Firstname,Lastname,Password,Gender,Email,Phone,RoleId,CreatedDate,ModifiedDate,CreatedBy,ModifiedBy,IsDeleted,id")] Person person)
        {
            if (id != person.id)
            {
                return NotFound();
